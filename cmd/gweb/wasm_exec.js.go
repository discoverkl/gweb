...
var execJSBytes = []byte(`// Copyright 2018 The Go Authors. All rights reserved.
    ...
    if (isNodeJS) {
        ...
        global.fs = {
            ...
            writeSync(fd, buf) {
                ...
                if (nl != -1) {
                    if (outputElem === null) { outputElem = document.getElementById("stdout"); }
                    if (outputElem === null) {
                        console.log(outputBuf.substr(0, nl));
                    }
                    else {
                        outputElem.innerText += (outputBuf.substr(0, nl) + "\n");
